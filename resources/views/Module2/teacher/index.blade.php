                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right space-x-2">
                                <a href="{{ route('teacher.show', $course->CourseID) }}" class="px-2 py-1 bg-blue-500 text-white rounded hover:bg-blue-600">👁️ View</a>
                                <a href="{{ route('teacher.assessments', $course->CourseID) }}" class="px-2 py-1 bg-purple-600 text-white rounded hover:bg-purple-700">📝 Assessments</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
