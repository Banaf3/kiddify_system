    ...
    <table class="table table-hover align-middle">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-end">
                    <a href="{{ route('admin.courses.edit', $course->CourseID) }}" class="btn btn-sm btn-warning">
                        ✏️ Edit
                    </a>

                    <a href="{{ route('admin.courses.students', $course->CourseID) }}" class="btn btn-sm btn-info text-white">
                        👥 Students
                    </a>

                    <form action="{{ route('admin.courses.destroy', $course->CourseID) }}" method="POST" class="d-inline"
