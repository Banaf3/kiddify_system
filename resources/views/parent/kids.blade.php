            ...
            <div
                ...
                <div class="p-8">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <h3 class="text-2xl font-bold text-[#5A9CB5]">My Kids</h3>
                            <p class="text-gray-600 mt-1">View and manage your children's profiles</p>
                        </div>
                        <a href="{{ route('parent.add-kid') }}"
                            class="inline-flex items-center px-4 py-2 bg-[#5A9CB5] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#4A8CA5] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#5A9CB5] transition ease-in-out duration-150 shadow-md">
                    ...
                    @if ($kids->count() > 0)
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            @foreach ($kids as $kid)
                                <div
                                    class="bg-white rounded-[24px] p-6 border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300">
                                    <div class="flex items-center mb-4">
                                        <div
                                            class="w-16 h-16 rounded-full flex items-center justify-center text-white text-2xl font-bold bg-[#5A9CB5]">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                                        {{ $kid->account_status == 'active' ? 'bg-[#5A9CB5]/10 text-[#5A9CB5]' : 'bg-[#FA6868]/10 text-[#FA6868]' }}">
