    ...
    public function authenticate(): void
    {
        ...
        if (!$user) {
            ...
            throw ValidationException::withMessages([
                'email' => 'This email address is not registered in our system. Please check your email or sign up for an account.',
            ]);
        }
        ...
        if (! Auth::attempt($this->only('email', 'password'), $this->boolean('remember'))) {
            ...
            throw ValidationException::withMessages([
                'email' => 'These credentials do not match our records. Please check your password.',
            ]);
        }
